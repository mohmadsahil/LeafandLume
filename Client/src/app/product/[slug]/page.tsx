      ...
      <Container>
        ...
        <div className="grid gap-6 sm:gap-10 lg:grid-cols-2">
          <div className="space-y-3">
            <div className="relative aspect-square overflow-hidden rounded-2xl bg-secondary sm:rounded-[2rem]">
              <Image
                src={product.image}
                alt={product.name}
                fill
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-6 flex flex-wrap items-baseline gap-x-3 gap-y-1">
              <span className="font-heading text-2xl font-semibold sm:text-3xl">${product.price}</span>
            ...
            <ul className="mt-6 grid grid-cols-1 gap-2 text-center text-xs xs:grid-cols-3 xs:text-[11px]">
              {[
                ...
                <li
                  key={label}
                  className="flex flex-row items-center justify-center gap-2 rounded-2xl border bg-card p-3 xs:flex-col xs:gap-1"
                >
