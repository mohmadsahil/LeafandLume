    ...
    <section className="bg-cream-gradient">
      <Container size="md" className="grid min-h-[70vh] place-items-center py-16 text-center">
        <div>
          ...
          <p className="mt-8 font-heading text-[4.5rem] font-semibold leading-none tracking-tighter text-primary xs:text-[6rem] sm:text-[9rem]">
            404
          </p>
          <h1 className="mt-2 font-heading text-xl font-semibold xs:text-2xl sm:text-3xl">
