...
export function CartClient() {
  ...
  return (
    <div className="mt-8 grid gap-6 lg:grid-cols-[1.6fr_1fr] lg:gap-10">
      <ul className="divide-y rounded-3xl border bg-card px-4 sm:px-6">
      ...
      <aside className="space-y-4">
        <div className="shadow-soft rounded-3xl border bg-card p-4 sm:p-6">
          ...
          <form onSubmit={onApply} className="mt-5 flex flex-col items-stretch gap-2 sm:flex-row sm:items-center">
