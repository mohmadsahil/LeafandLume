  ...
  return (
    <article>
        ...
        <Container>
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_1fr]">
            <div>
              ...
              <h1 className="mt-4 text-balance font-heading text-4xl font-semibold leading-[1.05] tracking-tight sm:text-6xl">
                Skincare grown the{' '}
          ...
          <div className="shadow-luxury overflow-hidden rounded-[2rem] border bg-card">
            <div className="grid gap-0 md:grid-cols-[1fr_1.4fr]">
              ...
              <div className="p-7 sm:p-10">
                ...
                <blockquote className="mt-5 font-heading text-xl leading-snug text-foreground sm:text-2xl">
      ...
      <section className="pb-20">
        <Container>
          <div className="relative overflow-hidden rounded-[2rem] border bg-foreground p-10 text-center text-background sm:p-14">
            <div
              aria-hidden
