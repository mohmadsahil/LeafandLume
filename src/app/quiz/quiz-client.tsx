      ...
      <AnimatePresence mode="wait">
        ...
        {phase === 'playing' && current && (
          <motion.div
            ...
            className="shadow-luxury relative overflow-hidden rounded-3xl border bg-card p-4 sm:p-6 md:p-8"
          >
            {/* HUD */}
            ...
            <div className="mt-6 flex items-start gap-3 sm:gap-5">
              ...
              <h2 className="flex-1 text-balance font-heading text-lg font-semibold leading-snug xs:text-xl sm:text-2xl">
                {current.prompt}
              </h2>
            </div>
                ...
                return (
                  <li key={i}>
                    <motion.button
                      ...
                      className={cn(
                        'group flex w-full items-center gap-3 rounded-2xl border bg-background p-3 text-left transition-all sm:p-4',
...
function IntroPanel({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: -16 }}
      transition={{ duration: 0.25 }}
      className="shadow-luxury relative overflow-hidden rounded-3xl border bg-card p-5 sm:p-7 md:p-10"
    >
      <div
        aria-hidden
      ...
      <div className="relative">
        ...
        <h2 className="mt-4 font-heading text-2xl font-semibold leading-tight xs:text-3xl sm:text-4xl">
...
function ResultPanel({
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative grid gap-6 sm:gap-8 md:grid-cols-[1.1fr_1fr] md:items-center">
        <div>
          <Badge variant="soft" className="rounded-full">
            <Award className="mr-1 size-3" /> Quiz complete
          </Badge>
          <h2 className="mt-3 font-heading text-2xl font-semibold xs:text-3xl sm:text-4xl">
