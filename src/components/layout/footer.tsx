...
export function Footer() {
  return (
    <footer className="bg-cream-gradient relative mt-12 overflow-hidden border-t">
      ...
      <Leaf
        aria-hidden
        className="pointer-events-none absolute -right-10 -top-10 size-40 rotate-12 text-primary/[0.07]"
      />
      <Leaf
        aria-hidden
        className="pointer-events-none absolute -bottom-12 -left-10 size-44 -rotate-12 text-primary/[0.05]"
      />
