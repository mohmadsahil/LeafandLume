...
export function ConcernsSection() {
  return (
    <section id="concerns" aria-labelledby="concerns-heading" className="relative py-20 sm:py-28">
      <Container>
        <div className="grid gap-12 lg:grid-cols-[5fr_7fr] lg:items-start lg:gap-16">
          ...
          <div className="lg:sticky lg:top-24">
            ...
            <h2
              id="concerns-heading"
              className="mt-3 text-balance font-heading text-4xl font-semibold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl"
            >
