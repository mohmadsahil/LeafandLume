    ...
    >
      <Container>
        ...
        <div
          ...
          className="no-scrollbar -mx-4 mt-10 flex gap-2 overflow-x-auto px-4 sm:mx-0 sm:flex-wrap sm:justify-center sm:px-0"
        >
        ...
        <article className="shadow-luxury mt-8 grid grid-cols-1 overflow-hidden rounded-[2rem] border bg-background lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div
            className={cn(
              'relative h-52 overflow-hidden transition-colors duration-500 sm:h-60 lg:h-auto lg:min-h-[340px]',
              active.color,
            )}
          >
            {/* Concentric rings */}
