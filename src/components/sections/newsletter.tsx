...
export function Newsletter() {
  ...
  return (
    <section aria-labelledby="newsletter" className="py-16 sm:py-20">
      <Container size="md">
        <div className="shadow-luxury relative overflow-hidden rounded-[2rem] bg-foreground p-8 text-background sm:p-12">
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <h2
              id="newsletter"
              className="mt-4 max-w-xl text-balance font-heading text-3xl font-semibold leading-tight sm:text-4xl"
            >
