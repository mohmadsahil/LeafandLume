            ...
            {promoBanners.map((banner) => (
              <CarouselItem key={banner.id} className="basis-full pl-3 sm:basis-1/2 lg:basis-1/3">
                <Link
                  ...
                  className={cn(
                    'shadow-soft group relative flex h-40 flex-col justify-between overflow-hidden rounded-3xl bg-gradient-to-br p-4 transition-transform hover:-translate-y-1 sm:h-48 sm:p-5 lg:h-52',
                    banner.gradient,
                  )}
                >
                  <div>
