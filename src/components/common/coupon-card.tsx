    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-3 font-heading text-lg font-semibold leading-tight">{coupon.title}</h3>
      ...
      <div className="mt-4 flex items-center gap-3 border-t border-dashed pt-4">
        <code className="rounded-lg bg-secondary px-3 py-1.5 font-mono text-sm tracking-wider">
          {coupon.code}
        </code>
        <Button
